        ...
        {productCategories.map((product, i) => (
          ...
          >
            <Link href={product.link}>
              <div className="group border-background2 bg-background relative flex h-full cursor-pointer flex-col items-center gap-6 overflow-hidden rounded-2xl border p-6 shadow-lg transition-all duration-200 hover:shadow-xl sm:flex-row">
